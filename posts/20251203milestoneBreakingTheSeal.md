...
Once you move, momentum takes over. The code writes itself. The exam answers flow.

Don't worry about the last 10 miles. Worry about the first step.
**Start, and you have already won.**
...
**真正开始的那一刻，其实你已经完成了 90%。**

在物理学中，**静摩擦力**（让物体动起来所需的力）永远大于**动摩擦力**（维持物体运动所需的力）。
打开 IDE 前的焦虑、踏上寒冷站台前的犹豫、考试开始前的恐惧——这些都是巨大的静摩擦力。
一旦你动起来了，惯性就会接管一切。代码会顺着指尖流淌，答案会自然浮现。
